...
build/swivview: src/viewer.c src/game.c src/game.h src/swivdata.c src/swivdata.h $(ENGINE) src/engine/engine.h
	mkdir -p build && $(CC) $(CFLAGS) -o $@ src/viewer.c src/game.c src/swivdata.c $(ENGINE) $(RAYLIB)
