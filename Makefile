...
build/swivview: src/viewer.c src/frontend.c src/frontend.h src/audio.c src/sfx_bank.c src/swivdata.c src/swivdata.h $(ENGINE) src/engine/engine.h
	mkdir -p build && $(CC) $(CFLAGS) -o $@ src/viewer.c src/frontend.c src/audio.c src/sfx_bank.c src/swivdata.c $(ENGINE) $(RAYLIB)
